const reports = {
  'sail-away': {
    ...
    deliverables: [
      { title: 'Sail Away Growth Simulator', description: 'Simulador interactivo publicado para estimar crecimiento rentable.', status: 'Publicado', state: 'done', href: '/library/simulators/sail-away/' },
